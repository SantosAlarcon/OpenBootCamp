 ...
 */
const getAllKatas = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let kataModel = (0, Kata_Entity_1.kataEntity)();
        // Buscar todos los katas
        return yield kataModel.find({});
    }
    catch (error) {
...
const getSortByValoration = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let kataModel = (0, Kata_Entity_1.kataEntity)();
        return yield kataModel.find({}).sort({ "valoration": -1 });
    }
    catch (error) {
