...
exports.logoutUser = exports.loginUser = exports.registerNewUser = exports.updateUserById = exports.createNewUser = exports.deleteUserById = exports.getUserById = exports.getKatasFromUser = exports.getAllUsers = void 0;
...
const getKatasFromUser = (page, limit, id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let userModel = (0, User_Entity_1.userEntity)();
        let kataModel = (0, Kata_Entity_1.kataEntity)();
        let response = {};
        yield userModel.findById(id).then((usuario) => __awaiter(void 0, void 0, void 0, function* () {
            response.user = usuario.name;
            response.email = usuario.email;
            let objectIds = [];
            // Iteramos sobre las katas
            usuario.katas.forEach((kataID) => {
                let objectId = new mongoose_1.default.Types.ObjectId(kataID);
                objectIds.push(objectId);
            });
            yield kataModel.find({
                "_id": { "$in": objectIds }
            }).then((katas) => {
        ...
        (0, logger_1.LogError)(`[ERROR ORM] Error a la hora de obtener los katas del usuario ${id}. ${error}.`);
    }
});
exports.getKatasFromUser = getKatasFromUser;
/**
...
const getUserById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let userModel = (0, User_Entity_1.userEntity)();
        return yield userModel.findById(id).select("name email age katas");
    }
    catch (error) {
