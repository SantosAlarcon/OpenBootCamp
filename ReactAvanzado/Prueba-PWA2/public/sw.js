...
define(['./workbox-6e567876'], (function (workbox) { 'use strict';
  ...
  */
  self.addEventListener('install', event => {
    self.registration.showNotification(`Nueva actualización disponible: ${version}`, {body: "Recomendamos instalar la última versión para acceder a nuevas funciones y correcciones de fallos."});
  });
  ...
  self.addEventListener('activate', event => {
    self.registration.showNotification(`Nueva actualización aplicada: ${version}`, {body: "Acabas de actualizar esta app a la última versión :)."});
  });

  // Este listener actuará cuando se añada un elemento a un array.
